...
/* Last update: Mon, 15 Nov 2010 10:56:40 GMT                                */
/*              by Oleg N. Scherbakov, mailto:oleg@7zsfx.info                */
/* Revision:    296                                                          */
/*---------------------------------------------------------------------------*/
/* Revision:    154                                                          */
...
#ifdef _DEBUG
	#define SFXBUILD_OPTIONS1	0xfff
#endif // _DEBUG
...
#define SFXBUILD_OPTIONS3_TEST					0x001
#define SFXBUILD_OPTIONS3_WIN7_PROGRESSBAR		0x002
#define SFXBUILD_OPTIONS3_RTF_CONTROL			0x004
#define SFXBUILD_OPTIONS3_IMAGES				0x008
#define SFXBUILD_OPTIONS3_LANG					0x010
#define SFXBUILD_OPTIONS3_ELEVATION				0x020
#define SFXBUILD_OPTIONS3_CHECK_RAM				0x040
#define SFXBUILD_OPTIONS3_CHECK_FREE_SPACE		0x080
#define SFXBUILD_OPTIONS3_BEGINPROMPTTIMEOUT	0x100
#define SFXBUILD_OPTIONS3_CONFIG_PLATFORM		0x200
#define SFXBUILD_OPTIONS3_EARLY_PASSWORD		0x400


#if (SFXBUILD_OPTIONS1&SFXBUILD_OPTIONS1_COMPRESS_COPY) != 0 && !defined(COMPRESS_COPY)
	#define COMPRESS_COPY
#endif
#if (SFXBUILD_OPTIONS1&SFXBUILD_OPTIONS1_COMPRESS_BCJ) != 0 && !defined(COMPRESS_BCJ)
	#define COMPRESS_BCJ
#endif
#if (SFXBUILD_OPTIONS1&SFXBUILD_OPTIONS1_COMPRESS_BCJ2) != 0 && !defined(COMPRESS_BCJ2)
	#define COMPRESS_BCJ2
#endif
#if (SFXBUILD_OPTIONS1&SFXBUILD_OPTIONS1_COMPRESS_DEFLATE) != 0 && !defined(COMPRESS_DEFLATE)
	#define COMPRESS_DEFLATE
#endif
#if (SFXBUILD_OPTIONS1&SFXBUILD_OPTIONS1_COMPRESS_LZMA) != 0 && !defined(COMPRESS_LZMA)
	#define COMPRESS_LZMA
#endif
#if (SFXBUILD_OPTIONS1&SFXBUILD_OPTIONS1_COMPRESS_LZMA2) != 0 && !defined(COMPRESS_LZMA2)
	#define COMPRESS_LZMA2
#endif
#if (SFXBUILD_OPTIONS1&SFXBUILD_OPTIONS1_COMPRESS_PPMD) != 0 && !defined(COMPRESS_PPMD)
	#define COMPRESS_PPMD
#endif
#if (SFXBUILD_OPTIONS1&SFXBUILD_OPTIONS1_CRYPTO) == 0 && !defined(_NO_CRYPTO) && !defined(SFX_CRYPTO)
	#define _NO_CRYPTO
#else
	#ifndef SFX_CRYPTO
		#define SFX_CRYPTO
...
#if (SFXBUILD_OPTIONS2&SFXBUILD_OPTIONS2_PREFIX_PLATFORM) != 0 && !defined(_SFX_USE_PREFIX_PLATFORM)
	#define _SFX_USE_PREFIX_PLATFORM
#endif

#if (SFXBUILD_OPTIONS2&SFXBUILD_OPTIONS2_PREFIX_WAITALL) != 0 && !defined(_SFX_USE_PREFIX_WAITALL)
	#define _SFX_USE_PREFIX_WAITALL
#endif

#if (SFXBUILD_OPTIONS2&SFXBUILD_OPTIONS2_PREFIX_HIDCON) != 0 && !defined(_SFX_USE_PREFIX_HIDCON)
	#define _SFX_USE_PREFIX_HIDCON
#endif

#if (SFXBUILD_OPTIONS2&SFXBUILD_OPTIONS2_PREFIX_NOWAIT) != 0 && !defined(_SFX_USE_PREFIX_NOWAIT)
	#define _SFX_USE_PREFIX_NOWAIT
#endif

#if (SFXBUILD_OPTIONS2&SFXBUILD_OPTIONS2_PREFIX_FORCENOWAIT) != 0 && !defined(_SFX_USE_PREFIX_FORCENOWAIT)
...
#define SFXBUILD_OPTIONS2						\
...
#if (SFXBUILD_OPTIONS3&SFXBUILD_OPTIONS3_TEST) != 0 && !defined(_SFX_USE_TEST)
	#define _SFX_USE_TEST
#endif
#if (SFXBUILD_OPTIONS3&SFXBUILD_OPTIONS3_WIN7_PROGRESSBAR) != 0 && !defined(_SFX_USE_WIN7_PROGRESSBAR)
	#define _SFX_USE_WIN7_PROGRESSBAR
#endif
#if (SFXBUILD_OPTIONS3&SFXBUILD_OPTIONS3_RTF_CONTROL) != 0 && !defined(_SFX_USE_RTF_CONTROL)
	#define _SFX_USE_RTF_CONTROL
#endif
#if (SFXBUILD_OPTIONS3&SFXBUILD_OPTIONS3_IMAGES) != 0 && !defined(_SFX_USE_IMAGES)
	#define _SFX_USE_IMAGES
#endif
#if (SFXBUILD_OPTIONS3&SFXBUILD_OPTIONS3_LANG) != 0 && !defined(_SFX_USE_LANG)
	#define _SFX_USE_LANG
#endif
#if (SFXBUILD_OPTIONS3&SFXBUILD_OPTIONS3_ELEVATION) != 0 && !defined(_SFX_USE_ELEVATION)
	#define _SFX_USE_ELEVATION
#endif
#if (SFXBUILD_OPTIONS3&SFXBUILD_OPTIONS3_CHECK_RAM) != 0 && !defined(_SFX_USE_CHECK_RAM)
	#define _SFX_USE_CHECK_RAM
#endif
#if (SFXBUILD_OPTIONS3&SFXBUILD_OPTIONS3_CHECK_FREE_SPACE) != 0 && !defined(_SFX_USE_CHECK_FREE_SPACE)
	#define _SFX_USE_CHECK_FREE_SPACE
#endif
#if (SFXBUILD_OPTIONS3&SFXBUILD_OPTIONS3_BEGINPROMPTTIMEOUT) != 0 && !defined(_SFX_USE_BEGINPROMPTTIMEOUT)
	#define _SFX_USE_BEGINPROMPTTIMEOUT
#endif
#if (SFXBUILD_OPTIONS3&SFXBUILD_OPTIONS3_CONFIG_PLATFORM) != 0 && !defined(_SFX_USE_CONFIG_PLATFORM)
	#define _SFX_USE_CONFIG_PLATFORM
#endif
#if defined(SFX_CRYPTO) && (SFXBUILD_OPTIONS3&SFXBUILD_OPTIONS3_EARLY_PASSWORD) != 0
	...
	#undef SFXBUILD_OPTIONS3_TEST
	#define SFXBUILD_OPTIONS3_TEST					0
#endif
...
#endif
#ifndef _SFX_USE_EARLY_PASSWORD
	#undef SFXBUILD_OPTIONS3_EARLY_PASSWORD
	#define SFXBUILD_OPTIONS3_EARLY_PASSWORD		0
#endif

#undef SFXBUILD_OPTIONS3
#define SFXBUILD_OPTIONS3						\
	SFXBUILD_OPTIONS3_TEST					|	\
	...
	SFXBUILD_OPTIONS3_EARLY_PASSWORD		|	\
	0
