...
/* Last update: Sat, 27 Nov 2010 15:10:14 GMT                                */
/*              by Oleg N. Scherbakov, mailto:oleg@7zsfx.info                */
/* Revision:    309                                                          */
/*---------------------------------------------------------------------------*/
/* Revision:    154                                                          */
...
#define SFXBUILD_OPTIONS4_TEST					0x001
#define SFXBUILD_OPTIONS4_LANG					0x002
#define SFXBUILD_OPTIONS4_ELEVATION				0x004
#define SFXBUILD_OPTIONS4_CHECK_RAM				0x008
#define SFXBUILD_OPTIONS4_CHECK_FREE_SPACE		0x010
#define SFXBUILD_OPTIONS4_BEGINPROMPTTIMEOUT	0x020
#define SFXBUILD_OPTIONS4_CONFIG_PLATFORM		0x040
#define SFXBUILD_OPTIONS4_EARLY_PASSWORD		0x080
#define SFXBUILD_OPTIONS4_VOLUME_NAME_STYLE		0x100
